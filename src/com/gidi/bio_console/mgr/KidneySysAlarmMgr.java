 ...
 *
 */
public class KidneySysAlarmMgr {
	...
	private static  KidneySysAlarmMgr mInstance;
	
	public static KidneySysAlarmMgr getInstance(BioConsoleApplication Application){
		if(null == mInstance){
			mInstance = new KidneySysAlarmMgr(Application);
		}
		return mInstance;
	}

	public KidneySysAlarmMgr( BioConsoleApplication Application){
	...
	private String getVeinPreWarningMsg(){
		...
		case 0:
			...
			break;
		case 1:
			veinPreAlertMsg = mContext.getResources().getString(R.string.error_pre_right_kidney_artery_low_pre);
			break;
		case 2:
			veinPreAlertMsg = mContext.getResources().getString(R.string.error_pre_right_kidney_artery_high_pre);
		default:
			break;
		}
	...
	private String getVeinFlowWarningMsg(){
		...
		case 0:
			...
			break;
		case 1:
			veinFlowWarningMsg = mContext.getResources().getString(R.string.error_flow_right_kidney_artery_low_flow);
			break;
		case 2:
			veinFlowWarningMsg = mContext.getResources().getString(R.string.error_flow_right_kidney_artery_high_flow);
		default:
			break;
		}
	...
	private String getArtPreWarningMsg(){
		...
		case 0:
			...
			break;
		case 1:
			artPreWarningMsg = mContext.getResources().getString(R.string.error_pre_left_kidney_artery_low_pre);
			break;
		case 2:
			artPreWarningMsg = mContext.getResources().getString(R.string.error_pre_left_kidney_artery_high_pre);
		default:
			break;
		}
	...
	private String getArtFlowWarningMsg(){
		...
		case 0:
			...
			break;
		case 1:
			artFlowWarningMsg = mContext.getResources().getString(R.string.error_flow_left_kidney_artery_low_flow);
			break;
		case 2:
			artFlowWarningMsg = mContext.getResources().getString(R.string.error_flow_left_kidney_artery_high_flow);
		default:
			break;
		}
	...
	private String getArtFlowAlarmMsg(){
		...
		case 1:
			//disconnect;
			alarmArtFlowMsg = mContext.getResources().getString(R.string.disconnect_pump_left_kidney_artrey_flow);
			break;
		case 2:
			//abnormal;
			alarmArtFlowMsg = mContext.getResources().getString(R.string.abnormal_pump_left_kidney_artery_flow);
			break;
		default:
			break;
		}
	...
	private String getVeinFlowAlarmMsg(){
		...
		case 0:
			...
			break;
		case 1:
			alarmVeinFlowMsg = mContext.getResources().getString(R.string.disconnect_pump_right_kidney_artery_flow);
			break;
		case 2:
			alarmVeinFlowMsg = mContext.getResources().getString(R.string.abnormal_pump_right_kidney_artery_flow);
			break;
		default:
			break;
		}
				...
				if(artFlowAlarmStatus != 0 && veinFlowAlarmStatus == 0){
					...
					if(isVeinBackFlow){
						flowAlarmMsg.append(getArtFlowAlarmMsg()).append("/")
							.append(mContext.getResources().getString(R.string.error_backflow_right_kidney_artery));
					}else{
					...
					if(isArteryBackFlow){
						flowAlarmMsg.append(getVeinFlowAlarmMsg()).append("/")
							.append(mContext.getResources().getString(R.string.error_backflow_left_kidney_artery));
					}else{
					...
					if(isArteryBackFlow && !isVeinBackFlow){
						flowAlarmMsg.append(mContext.getResources().getString(R.string.error_backflow_left_kidney_artery));
					}else if(!isArteryBackFlow && isVeinBackFlow){
						flowAlarmMsg.append(mContext.getResources().getString(R.string.error_backflow_right_kidney_artery));
					}else if(isArteryBackFlow && isVeinBackFlow){
						flowAlarmMsg.append(mContext.getResources().getString(R.string.error_backflow_left_right_kidney_artery));
					}
				}				
		...
		if(null != mApplication){
			...
			if(mApplication.isArteryHeartConnect() && mApplication.isVeinHeartConnect()){
				if(artSpeedAlarm && !veinSpeedAlarm){
					alarmSpeedMsg.append(mContext.getResources().getString(R.string.alarm_msg_pump_left_kidney_artery_speed));
				}else if(!artSpeedAlarm && veinSpeedAlarm){
					alarmSpeedMsg.append(mContext.getResources().getString(R.string.alarm_msg_pump_right_kidney_artery_speed));
				}else if(artSpeedAlarm && veinSpeedAlarm){
					alarmSpeedMsg.append(mContext.getResources().getString(R.string.alarm_msg_pump_left_right_kidney_artery_speed));
				}else if(!artSpeedAlarm && !veinSpeedAlarm){
		...
		if(null != mApplication){
			if(mApplication.isArteryHeartConnect() && mApplication.isVeinHeartConnect()){
				if(isArteryBubAlert && !isVeinBubAlert){
					alarmBubbleMsg.append(mContext.getString(R.string.error_bubble_left_kidney_artery));
				}else if(!isArteryBubAlert && isVeinBubAlert){
					alarmBubbleMsg.append(mContext.getResources().getString(R.string.error_bubble_right_kidney_artery));
				}else if(isArteryBubAlert && isVeinBubAlert){
					alarmBubbleMsg.append(mContext.getResources().getString(R.string.error_bubble_left_right_kidney_artery));
				}else {
				...
				if(isArteryBubAlert){
					alarmBubbleMsg.append(mContext.getResources().getString(R.string.error_bubble_left_kidney_artery));
				}else{
					alarmBubbleMsg.append("");
				}
			}else if(!mApplication.isArteryHeartConnect() && !mApplication.isVeinHeartConnect()){
		...
		if(null != mApplication){
			if(mApplication.isArteryHeartConnect() && mApplication.isVeinHeartConnect()){
				if(veinPreAlarmStatus!= 0 && artPreAlarmStatus != 0){
					alarmpreMsg.append(mContext.getResources().getString(R.string.disconnect_pump_left_right_kidney_artery_pressure));
				}else if(artPreAlarmStatus !=0  && veinPreAlarmStatus == 0){
					alarmpreMsg.append(mContext.getResources().getString(R.string.disconnect_pump_left_kidney_artery));
				}else if(artPreAlarmStatus ==0  && veinPreAlarmStatus != 0){
					alarmpreMsg.append(mContext.getResources().getString(R.string.disconnect_pump_right_kidney_artery));
				}else{
					alarmpreMsg.append("");
				}
	...
	private String getSysCnectMsg(){
		...
		if(null != mApplication){
			if(!mApplication.isArteryHeartConnect() && !mApplication.isVeinHeartConnect()){
				disconnctMsg.append(mContext.getString(R.string.disconnect_pump_left_right_artery));
			}else if(mApplication.isArteryHeartConnect() && !mApplication.isVeinHeartConnect()){
				disconnctMsg.append(mContext.getString(R.string.disconnect_pump_right_kidney_artery));
			}else if(!mApplication.isArteryHeartConnect() && mApplication.isVeinHeartConnect()){
				disconnctMsg.append(mContext.getString(R.string.disconnect_pump_left_kidney_artery));
			}else{
				disconnctMsg.append("");
			}
		}	
