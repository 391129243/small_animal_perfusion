...
/**预灌注
 * 设置泵速，泵速默认是0选中，点击0表示**/
public class PreperfusionFragment extends BaseFragment implements OnClickListener{
    ...
    private OnPrePerfusionListener mListener;
	    
   public interface OnPrePerfusionListener{
	...
	public void setOnPrePerfusionListener(OnPrePerfusionListener listener){
	...
	private void initVariable(){
		...
		String perfusion_system = PreferenceUtil.getInstance(getActivity().getApplicationContext())
		...
		if(perfusion_system.equals(Constants.LIVER_PERFUSION_STYSTEM)){
			mArtPreTitleTv.setText(R.string.hepatic_artery_pressure);
			mVeinPreTitleTv.setText(R.string.portal_vein_pressure);	
			mArtFlowTitleTv.setText(R.string.hepatic_artery_flow);
			mVeinFlowTitleTv.setText(R.string.portal_vein_flow);
			mRArtSpeedTxt.setTitleText(getActivity().getResources().getString(R.string.hepatic_artery));
			mRVeinSpeedTxt.setTitleText(getActivity().getResources().getString(R.string.portal_vein));
		}else{
			mArtPreTitleTv.setText(R.string.preset_perfusion_left_kidney_pressure);
			mVeinPreTitleTv.setText(R.string.preset_perfusion_right_kidney_pressure);	
			mArtFlowTitleTv.setText(R.string.preset_perfusion_left_kidney_flow);
			mVeinFlowTitleTv.setText(R.string.preset_perfusion_right_kidney_flow);
			mRArtSpeedTxt.setTitleText(getActivity().getResources().getString(R.string.left_kidney_artery));
			mRVeinSpeedTxt.setTitleText(getActivity().getResources().getString(R.string.right_kidney_artery));
		}		
	}
