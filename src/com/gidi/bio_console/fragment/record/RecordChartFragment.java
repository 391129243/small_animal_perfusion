...
public class RecordChartFragment extends BaseFragment {
	...
	private List<SerialMessage> mRecordList;
	...
	private void initLineChart(){
		...
		mArtPreChartUtils.setDescription(getActivity().getResources().getString(R.string.hepatic_artery_pressure));
		...
		mArtPreChartUtils.setScaleEnable(false);
		mVeinPreChartUtils.setDescription(getActivity().getResources().getString(R.string.portal_vein_pressure));
		...
		mArtPreChartUtils.setScaleEnable(false);
		mArtFlowChartUtils.setDescription(getActivity().getResources().getString(R.string.hepatic_artery_flow));
		...
		mArtPreChartUtils.setScaleEnable(false);
		mVeinFlowChartUtils.setDescription(getActivity().getResources().getString(R.string.portal_vein_flow));
		...
		mArtPreChartUtils.setScaleEnable(false);
		mArtResIndexChartUtils.setDescription(getActivity().getResources().getString(R.string.record_title_artery_resistindex));
		...
		mArtPreChartUtils.setScaleEnable(false);
		mVeinResIndexChartUtils.setDescription(getActivity().getResources().getString(R.string.record_title_vein_resistindex));
	...
	protected int getLayoutResource() {
		// TODO Auto-generated method stub
		return R.layout.module_fragment_record_chart;
	}
	...
	private void onNotifyUpdateChart(){
		...
		if(mRecordList.size() > 0){
			int index = 0;
			for(SerialMessage msg : mRecordList){
				if(null != msg){
					Float mArtPreValue = StringUtil.convertToFloat(msg.getArtMeanPre(), 0.0f);
					Float mArtFlowValue = StringUtil.convertToFloat(msg.getArtFreal(), 0.0f);
					Float mVeinPreValue = StringUtil.convertToFloat(msg.getVeinPreal(), 0.0f);
					Float mVeinFlowValue =  StringUtil.convertToFloat(msg.getVeinFreal(), 0.0f);						
					Float artResIndexValue = getResistIndex(msg.getArtResistIndex());
					Float veinResIndexValue = getResistIndex(msg.getVeinResistIndex());
			...
			mArtPreChartUtils.setLineChartData(timeStamps, mArtPreList, 
					"Pressure/time",
					getActivity().getResources().getString(R.string.hepatic_artery_pressure), 
					R.color.blue);
			
			mArtFlowChartUtils.setLineChartData(timeStamps, mArtFlowList, 
					"Flow/time",
					getActivity().getResources().getString(R.string.hepatic_artery_flow), 
					R.color.blue);
			
			mVeinPreChartUtils.setLineChartData(timeStamps, mVeinPreList, 
					"Pressure/time",
					getActivity().getResources().getString(R.string.portal_vein_pressure), 
					R.color.blue);
			
			mVeinFlowChartUtils.setLineChartData(timeStamps, mVeinFlowList, 
					"Flow/time",
					getActivity().getResources().getString(R.string.portal_vein_flow), 
					R.color.blue);
			
			mArtResIndexChartUtils.setLineChartData(timeStamps, mArtResIndexList, 
					"ResistIndex/time",
					getActivity().getResources().getString(R.string.record_title_artery_resistindex), 
					R.color.blue);
			
			mVeinResIndexChartUtils.setLineChartData(timeStamps, mVeinResIndexList, 
					"ResistIndex/time",
					getActivity().getResources().getString(R.string.record_title_vein_resistindex), 
					R.color.blue);
