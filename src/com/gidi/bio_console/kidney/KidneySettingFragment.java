...
import com.gidi.bio_console.kidney.KidneySetAlertFragment.onKidneySetAlertListener;
import com.gidi.bio_console.kidney.KidneySetPerfusionFragment.onKidneySetPerfusionListener;

public class KidneySettingFragment extends BaseFragment implements onKidneySetPerfusionListener, onKidneySetAlertListener {

	private ControllerKidneySetting mSetController;
	private RadioGroup mSetRg_Tab;
	private RadioButton mPerfusion_rb;
	private boolean isFirstVisible = true;
	private KidneySetPerfusionFragment mSettingPerfusinFragment;
	private KidneySetAlertFragment mSettingAlertFragment;
	private onKidneySettingListener onSettingListener;
	public interface onKidneySettingListener{
	...
	public void setKidneySettingListener(onKidneySettingListener listener){
	...
	private void initVariables(){
		mSetController = ControllerKidneySetting.getInstance(this, R.id.setting_parent_container);
		mSetController.showFragment(0);
		mSettingPerfusinFragment = (KidneySetPerfusionFragment)mSetController.getFragment(0);
		mSettingAlertFragment = (KidneySetAlertFragment)mSetController.getFragment(1);
	}
	...
	protected void initListener() {
		...
		mSettingAlertFragment.setOnKidneySetAlertListener(this);
	}
