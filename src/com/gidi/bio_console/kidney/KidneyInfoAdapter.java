...
/**数据信息**/
public class KidneyInfoAdapter extends BaseAdapter{

	private Context mContext;
	private ArrayList<KidneyInfoBean> mList = new ArrayList<KidneyInfoBean>();
	private LayoutInflater mInflater;
	
	public KidneyInfoAdapter(Context context){
		this.mContext = context;
		this.mInflater = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	}
	
	public void setList(ArrayList<KidneyInfoBean> list){
		this.mList.clear();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final KidneyInfoBean kidneyInfoBean = mList.get(position);
		if(null == convertView){
			mHolder = new ViewHolder();
			convertView = mInflater.inflate(R.layout.module_list_kidneyinfo_item, null);
		...
		if(null != kidneyInfoBean){
			mHolder.mArtMeanPreTxt.setText(kidneyInfoBean.getLeftKidneyArtMeanPre());
			mHolder.mArtDiasPreTxt.setText(kidneyInfoBean.getLeftKidneyArtDiasPre());
			mHolder.mArtSystPreTxt.setText(kidneyInfoBean.getLeftKidneyArtSystPre());
			mHolder.mArtFreqPreTxt.setText(kidneyInfoBean.getLeftKidneyArtFreal());
			mHolder.mArtFrealTxt.setText(kidneyInfoBean.getLeftKidneyArtFreal());
			mHolder.mArtSpeedTxt.setText(kidneyInfoBean.getLeftKidneyArtSpeed());
			mHolder.mArtResistIndexTxt.setText(kidneyInfoBean.getLeftKidneyArtResistIndex());
			
			mHolder.mVeinFrealTxt.setText(kidneyInfoBean.getRightKidneyArtFreal());
			mHolder.mVeinPrealTxt.setText(kidneyInfoBean.getRightKidneyArtPmean());
			mHolder.mVeinSpeedTxt.setText(kidneyInfoBean.getRightKidneyArtSpeed());
			mHolder.mVeinResistIndexTxt.setText(kidneyInfoBean.getRightKidneyArtResistIndex());
			
			mHolder.mTempTxt.setText(kidneyInfoBean.getTemp());
			if(null != kidneyInfoBean.getMsgTime()){
				//显示需要改变时区
				mHolder.mMsgTimeTxt.setText(kidneyInfoBean.getMsgTime());
