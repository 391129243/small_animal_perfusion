...
public class KidneySetAlertEditText extends RelativeLayout implements OnClickListener{
	...
	public KidneySetAlertEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		 ...
		 mContentEt.setOnKeyboardActionListener(new KeyBoardActionListener() {
			...
			public void onTextChange(Editable editable) {
					...
					if(tempMode == 0){
						if(StringUtil.convertToFloat(textString, (float)0.0) > 100.0f){
							...
							if(null != onNumChangelistener){
								onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_left_kidney_artery_pressure_nmp);
							}
						}
					}else if(tempMode == 1){
						if(StringUtil.convertToFloat(textString, (float)0.0) > 40.0f){
							mContentEt.setText(40+"");
							if(null != onNumChangelistener){
								onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_left_kidney_artery_pressure_hmp);
							}
						}
					}
				...
				case MODE_SECOND_VEIN_PRESSURE:
					...
					if(tempMode == 0){
						if(vein_pressure > 100.0f){
							mContentEt.setText(100 + "");  
							if(null != onNumChangelistener){
								onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_pressure_nmp);
							}
						}
						
					}else if(tempMode == 1){
						if(vein_pressure > 40.0f){
							mContentEt.setText(40 + "");  
							if(null != onNumChangelistener){
								onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_pressure_hmp);
							}
						}
					}
				...
				case MODE_THIRD_ARTERY_FLOW:				
					if(StringUtil.convertToFloat(textString, (float)0.0) > 1000.0f){
						if(null != onNumChangelistener){
							...
							onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_left_kidney_artery_flow);
						}	
					}
					break;
				...
				case MODE_FORTH_VEIN_FLOW:
					...
					if(vein_flow > 1000.0f){
						mContentEt.setText(1000+"");		
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_flow);
						}	
					}
					break;
				...
				case MODE_ARTERY_SPEED:
					...
					if(artSpeed > 3000){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_left_kidney_artery_speed);
						}
					}	
					
					break;
				case MODE_VEIN_SPEED:
					int veinSpeed = StringUtil.convertToInt(editable.toString(), 1500);
					if(veinSpeed > 3000){
						mContentEt.setText(3000+"");
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_speed);
						}
					}	
			...
			switch (mode) {
			    ...
			    case MODE_SECOND_VEIN_PRESSURE:
			    	...
			    	if(tempMode == 0){
			    		...
			    		if(!(StringUtil.convertToFloat(addText, (float)0.0) > 40.0f)){
							mContentEt.setText(addText);
			    ...
			    case MODE_FORTH_VEIN_FLOW:
			    	...
			    	if(!(StringUtil.convertToFloat(addText, (float)0.0) > 1000)){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_pressure);
						}
			    ...
			    case MODE_ARTERY_SPEED:
			    	...
			    	if(addNumText >= 1500 && addNumText <= 3000){
			    		...
			    		if(null != onNumChangelistener){
			    			if(addNumText < 1500){
			    				onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_left_kidney_artery_speed);
			    ...
			    case MODE_VEIN_SPEED:
			    	...
			    	if(addNumText >= 1500 && addNumText <= 3000){
			    		...
			    		if(null != onNumChangelistener){
			    			if(addNumText < 1500){
			    				onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_right_kidney_artery_speed);
			    			}else if(addNumText > 3000){
								onNumChangelistener.displayErrorMsg(R.string.error_upper_limit_of_right_kidney_artery_speed);
			    			}
						}
			...
			switch (mode) {
			    case MODE_FIRST_ARTERY_PRESSURE:	
					...
					if(StringUtil.convertToFloat(subText, (float)0.0) >= 0){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_left_kidney_artery_pressure);
						}
			    ...
			    case MODE_SECOND_VEIN_PRESSURE:
					...
					if(StringUtil.convertToFloat(subText, (float)0.0) >= 0){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_right_kidney_artery_pressure);
						}
			    ...
			    case MODE_THIRD_ARTERY_FLOW:
			    	...
			    	if(StringUtil.convertToFloat(subText, (float)0.0) >= 0){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_left_kidney_artery_flow);
						}
			    ...
			    case MODE_FORTH_VEIN_FLOW:
			    	...
			    	if(StringUtil.convertToFloat(subText, (float)0.0)>=0){
						...
						if(null != onNumChangelistener){
							onNumChangelistener.displayErrorMsg(R.string.error_lower_limit_of_right_kidney_artery_flow);
						}
