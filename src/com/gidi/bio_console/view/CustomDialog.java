...
public class CustomDialog extends Dialog{
	...
	private int iconResId = R.drawable.ic_prompt ;
	...
	*/  
	public Builder setPositiveButton(int positiveButtonText,  
	 ...
	 public CustomDialog create() {  
		 ...
		 if(iconResId != R.drawable.ic_prompt){
			 ...
			 ((ImageView)layout.findViewById(R.id.dialog_title_img)).setImageResource(R.drawable.ic_prompt);
		 }
